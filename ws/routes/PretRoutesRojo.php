...
Flight::route('POST /save-simulation', [$remboursement_controller, 'saveSimulation']);
Flight::route('GET /simulations', [$remboursement_controller, 'getSimulations']);
...
Flight::route('GET /fond-etablissement', [$gestion_controller, 'getFondEtablissement']);
?>