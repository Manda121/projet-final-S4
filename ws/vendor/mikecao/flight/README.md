...
Flight::register('db', 'PDO', array('mysql:host=127.0.0.1;dbname=test','root','yume'));
...
Flight::register('db', 'PDO', array('mysql:host=127.0.0.1;dbname=test','root','yume'), function($db){
